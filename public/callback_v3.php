...
function create_event($config, $data, $db) {
    ...
    $event_keys = array(
        'bounce'      => array('reason','status','smtp-id','type'),
        'click'       => array('ip','url','useragent'),
        'deferred'    => array('attempt','response','smtp-id'),
        'delivered'   => array('response','smtp-id'),
        'dropped'     => array('reason','smtp-id'),
        'open'        => array('ip','useragent'),
        'processed'   => array('smtp-id'),
        'spamreport'  => array('ip','useragent'),
        'unsubscribe' => array('ip','useragent')
    );
    $basic_keys = array('category','email','event','timestamp');
